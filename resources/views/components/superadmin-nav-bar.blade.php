<nav class="navbar">
    <div class="container-fluid">
        ...
        <div class="header-logo">
            <a href="#">
                <img class="d-none d-lg-block" src="{{asset('public/logo.png')}}" alt="...">
                <img class="d-lg-none d-sm-block" src="{{asset('public/logo.png')}}" alt="...">
            </a>
        </div>
        ...
        <div class="header-body">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                        <div class="dropdown-menu-title d-flex justify-content-between"
                             data-backround-image="{{asset('public/admin/media/image/image1.png')}}">
                            <div>
                ...
                <li class="nav-item d-none d-lg-block">
                    <a href="#" class="nav-link sidebar-open" data-sidebar-target="#settings">
                        <i class="fa fa-cog"></i>
                    </a>
                </li> --}}
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                        <div class="dropdown-menu-title text-center"
                            ...
                            <figure class="avatar avatar-state-success avatar-sm m-b-10 bring-forward">
                                <img src="{{asset('public/admin/media/image/avatar.jpg')}}" class="rounded-circle" alt="image">
                            </figure>
                            <h6 class="text-uppercase font-size-12 m-b-0">{{session('loggedIn')['email']}}</h6>
                        </div>
                        <div class="dropdown-menu-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <a href="{{asset('logout')}}" class="list-group-item text-danger">Logout</a>
                            </ul>
                        </div>
                    </div>
                </li>
