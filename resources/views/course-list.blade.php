											...
											<div class="row">
												...
												<div class="col-xss-12 col-xs-3 col-sm-3">
													<div class="sort-by-wrapper for-layout-option">
														...
														<div class="sorting-middle-holder">
															<a href="{{asset('course-list')}}" class="btn btn-sorting active"><i class="fa fa-th-list"></i></a>
															<a href="{{asset('course-grid')}}" class="btn btn-sorting"><i class="fa fa-th-large"></i></a>
														</div>
													</div>
												</div>
												...
												<div class="col-xss-12 col-xs-8 col-sm-8 col-md-8">
													...
													<div class="content">
															...
															?>
																...
																<div class="col-xss-7 col-xs-8 col-sm-8 col-md-6">
																	<div class="course-instructor">
																		<div class="image">
																			<img src="{{asset('public/frontend/images/man/01.jpg')}}" alt="Image" class="img-circle" />
																		</div>
														...
														<ul class="meta-list clearfix">
															<li><i class="fa fa-folder-open-o"></i><span class="block"> {{$product->category}}</span></li>
