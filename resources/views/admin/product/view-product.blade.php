            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <x-flashMessage/>
                        <h6 class="card-title">View Product</h6>
                        <form action="{{asset('admin/edit-product/'.Request::segment(3))}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="username">Product Name</label>
                                <input type="text" class="form-control" readonly name="name" value="{{$product->name}}" id="name" placeholder="Enter Product Name">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_desc" readonly placeholder="Enter Short desc.." class="form-control" id="" cols="30" rows="10">{{$product->short_desc}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" readonly placeholder="Enter Short desc.." class="form-control" id="" cols="30" rows="10">{{$product->description}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly name="videoUrl" value="{{$product->video_url}}" id="videoUrl" placeholder="Enter Video Url">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly name="features" value="{{$product->features}}" id="features" placeholder="Enter Features">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" readonly name="sort_order" value="{{$product->sort_order}}" id="sort_order" placeholder="Enter Sort Order">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly name="slug" value="{{$product->slug}}" id="slug" placeholder="Enter slug">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                ...
                                <input type="file" readonly class="custom-file-input" name="image" id="customFile">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single" name="status" readonly>
