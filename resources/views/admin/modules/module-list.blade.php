...
<main class="main-content">
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <a href="{{asset('admin/add-module')}}" class="btn btn-primary">Add Module</a>
                <table id="example1" class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($permission == 'read')
                            <a  href="{{asset('admin/view-admin-module/'.$module->id)}}"><i class="fa fa-eye text-primary"></i></a>
                           
                            @endif

                            @if($permission == 'write')
                            <a  href="{{asset('admin/view-admin-module/'.$module->id)}}"><i class="fa fa-eye text-primary"></i></a>
                            <a  href="{{asset('admin/edit-admin-module/'.$module->id)}}"><i class="fa fa-edit text-success"></i></a>
                            ...
                            <a  href="{{asset('admin/view-admin-module/'.$module->id)}}"><i class="fa fa-eye text-primary"></i></a>
                            <a  href="{{asset('admin/edit-admin-module/'.$module->id)}}"><i class="fa fa-edit text-success"></i></a>
                            <a class="delete-confirm" href="{{asset('admin/delete-admin-module/'.$module->id)}}"><i class="fa fa-trash text-danger"></i></a>
                            @endif
