    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <a href="{{asset('admin/re-video-list')}}"  class="btn btn-primary"><i class="fa fa-refresh"></i>&nbsp; Reset</a>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{asset('admin/re-upload-video')}}" class="form-group btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp; Upload Video</a>
                ...
                <table  class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{$product->size}}</td>
                        {{-- <td>{{$product->date}}</td> --}}
                        <td><a href="{{asset('admin/tag-list/'.$product->etag)}}"><i class="fa fa-plus"></i></a></td>
                        ...
                        <td>
                            ...
                            {{-- <a  href="{{asset('admin/view-product/'.$product->id)}}"><i class="fa fa-eye text-primary"></i></a> --}}
                            <a  href="{{asset('admin/edit-re-video/'.$product->etag)}}"><i class="fa fa-edit text-success"></i></a>
                            <a  href="{{asset('admin/delete-re-video/'.$product->etag)}}" class="delete-confirm"   ><i class="fa fa-trash text-danger"></i></a>
                            @endif
