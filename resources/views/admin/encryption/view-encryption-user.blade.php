                    ...
                    <div class="card-body">
                        ...
                        <form action="{{asset('admin/edit-encryption-user/'.Request::segment(3))}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly name="username" value="{{(!empty($adminUser->username))?$adminUser->username:""}}" id="username" placeholder="Enter User Name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" readonly name="email" value="{{(!empty($adminUser->email))?$adminUser->email:""}}" id="email" placeholder="Enter Email Name">
