...
<!-- begin::chart -->
<script src="{{asset('public/admin/vendors/charts/chartjs/chart.min.js')}}"></script>
<script src="{{asset('public/admin/vendors/charts/sparkline/sparkline.min.js')}}"></script>
<script src="{{asset('public/admin/vendors/circle-progress/circle-progress.min.js')}}"></script>
<script src="{{asset('public/admin/js/examples/charts.js')}}"></script>
<!-- end::chart -->

<!-- begin::vamp -->
<script src="{{asset('public/admin/vendors/vmap/jquery.vmap.min.js')}}"></script>
<script src="{{asset('public/admin/vendors/vmap/maps/jquery.vmap.usa.js')}}"></script>
<script src="{{asset('public/admin/js/examples/vmap.js')}}"></script>
<!-- end::vamp -->


<script src="{{asset('public/admin/vendors/datepicker/daterangepicker.js')}}"></script>
<script src="{{asset('public/admin/js/examples/dashboard.js')}}"></script>
