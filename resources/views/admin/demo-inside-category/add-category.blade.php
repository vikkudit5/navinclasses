    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{asset('admin/demo-category-list/'.Request::segment(3).'/'.Request::segment(4))}}" class="btn btn-primary pull-right"><i class="fa fa-list"></i>&nbsp; Category List</a>
                        <x-flashMessage/>
                        <h6 class="card-title">Add Category</h6>  
                        <form action="{{asset('admin/save-demo-category')}}" method="post" enctype="multipart/form-data">		
