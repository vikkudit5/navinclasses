...
<main class="main-content">
    ...
    <div class="container">
                ...
                <ol class="breadcrumb">   				
					...
					@if(isset($nav_links))	
						@foreach($nav_links as $key=>$value)   
							...
							@else
								<li class="breadcrumb-item" aria-current="page"><a href="{{URL::to('admin/category-list/'.$info->id.'/'.$key)}}">{{$value}}</a></li> 
							@endif
							@php
								++$i  
							@endphp 							 
        ...
        <div class="card">
            ...
            <div class="card-body">
			<x-flashMessage/>
                <a href="{{asset('admin/add-category/'.Request::segment(3).'/'.Request::segment(4))}}" class="form-group btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp; Add Category</a>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        ?>
						<td><a href="{{asset('admin/category-list/'.$category->product_id.'/'.$category->id)}}"><i class="fa fa-plus"></i></a></td>
                        <?php }else{ ?>
                            <td><a href="{{asset('admin/content-list/'.$category->product_id.'/'.$category->id)}}"><i class="fa fa-plus"></i></a></td>
                            <?php } ?>
                        <td>
