...
<main class="main-content">
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <a href="{{asset('admin/add-admin-user')}}" class="btn btn-primary">Add User</a>
                <table id="example1" class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="{{asset('admin/module-permission/'.$admin_user->id)}}"><i class="fa fa-plus"></i></a></td>
                        <td>
                            <?php 
                            ...
                            @if($permission == 'read')
                            <a  href="{{asset('admin/view-admin-user/'.$admin_user->id)}}"><i class="fa fa-eye text-primary"></i></a>
                           
                            @endif

                            @if($permission == 'write')
                            <a  href="{{asset('admin/view-admin-user/'.$admin_user->id)}}"><i class="fa fa-eye text-primary"></i></a>
                            <a  href="{{asset('admin/edit-admin-user/'.$admin_user->id)}}"><i class="fa fa-edit text-success"></i></a>
                            
                            @endif

                            @if($permission == 'delete')
                            <a  href="{{asset('admin/reset-user-password/'.$admin_user->id)}}"><i class="fa fa-undo text-primary"></i></a>
                            <a  href="{{asset('admin/view-admin-user/'.$admin_user->id)}}"><i class="fa fa-eye text-primary"></i></a>
                            <a  href="{{asset('admin/edit-admin-user/'.$admin_user->id)}}"><i class="fa fa-edit text-success"></i></a>
                            <a  href="{{asset('admin/delete-admin-user/'.$admin_user->id)}}" class="delete-confirm"   ><i class="fa fa-trash text-danger"></i></a>
                            @endif
