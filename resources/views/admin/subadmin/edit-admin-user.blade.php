            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{asset('admin/edit-admin-user/'.Request::segment(3))}}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="institute" value="{{(!empty($adminUser->institute))?$adminUser->institute:""}}" id="institute" placeholder="Enter Institute">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single" name="adminRole">
                                    ...
                                    <option value="{{$role->id}}" {{(!empty($adminUser->username))? "selected":""}}>{{$role->role}}</option>
                                    @endforeach
                                    @endif
