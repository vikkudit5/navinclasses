            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{asset('admin/add-module-permission')}}" method="post">
                            @csrf

                            <div class="form-group">
                                <label for="institute">Admin User</label>
                                <select class="js-example-basic-single" name="adminUserId">
                                    <option></option>
                                ...
                                @if ($errors->has('adminUserId'))
                                <div class="error">
                                    {{ $errors->first('adminUserId') }}
                                </div>
                                @endif
                            </div>
