                    ...
                    <div class="card-body">
                        ...
                        <form action="{{asset('admin/edit-user/'.Request::segment(3))}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" value="{{(!empty($users->name))?$users->name:""}}" id="name" placeholder="Enter  Name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email" value="{{(!empty($users->email))?$users->email:""}}" id="email" placeholder="Enter Email Name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="phone" value="{{(!empty($users->phone))?$users->phone:""}}" id="phone" placeholder="Enter Phone">
