            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{asset('admin/add-user')}}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" class="form-control" name="cpassword" value="{{old('cpassword')}}" id="cpassword" placeholder="Enter Password">
