    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{asset('admin/mcq-question-list')}}" class="btn btn-primary pull-right"><i class="fa fa-list"></i>&nbsp; MCQ Question List</a>
                        <x-flashMessage/>
                        ...
                        <form action="{{asset('admin/edit-mcq-question/'.Request::segment(3))}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="question" id="question" readonly class="form-control" cols="30" rows="10">{!! $mcq_questions->question !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="solution" id="solution" readonly class="form-control" cols="30" rows="10">{!! $mcq_questions->solution !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="conceptual_type" id="" readonly class="form-control" value="{{ $mcq_questions->conceptual_type }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="level" id="" readonly class="form-control" value="{{ $mcq_questions->level }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="code" id="" readonly class="form-control" value="{{ $mcq_questions->code }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single" readonly name="correct_option">
