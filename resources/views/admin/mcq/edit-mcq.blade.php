                    ...
                    <div class="card-body">
                        ...
                        <form action="{{asset('admin/edit-mcq/'.Request::segment(3))}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" value="{{$mcq->name}}" class="form-control" value="">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="instruction" id="instruction"  class="form-control" cols="30" rows="10" placeholder="instruction">{{$mcq->instruction}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="time_limit" id="" class="form-control" value="{{$mcq->time_limit}}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="retake_attempt" id="retake_attempt">
                                    ...
                                    <option value="unlimited" {{($mcq->retake_attempt=='1')?"selected":""}}>Unlimited</option>
                                    <option value="limited" {{($mcq->retake_attempt=='0')?"selected":""}}>limited</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="minimum_time_submit" id="" class="form-control" value="{{$mcq->minimum_time_submit}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="passing_percent" id="passing_percent" class="form-control" value="{{$mcq->passing_percentage}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="correct_marks" id="correct_marks" class="form-control" value="{{$mcq->correct_marks}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="negative_marks" id="negative_marks" class="form-control" value="{{$mcq->negative_marks}}">
