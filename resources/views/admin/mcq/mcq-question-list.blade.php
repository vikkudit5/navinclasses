...
<main class="main-content">
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Mcq Question List</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="{{asset('admin/upload-question')}}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="form-group col-md-2">
                <button type="submit" class="form-group btn btn-danger pull-right"><i class="fa fa-upload"></i>&nbsp; Upload Question</button>
            </div>
            ...
            <div class="card-body">
                ...
                <table  class="table table-striped table-bordered">
                    ...
                    <tr>
                       ...
                       <td>{{$mcq_question->options}}</td>
                       <td>{{$mcq_question->code}}</td>
                       <td><a href="{{asset('admin/mcq-option-list/'.$mcq_question->id)}}"><i class="fa fa-plus text-primary"></i></a></td>
                        ...
                        <td>
                            ...
                            <a  href="{{asset('admin/view-mcq-question/'.$mcq_question->id)}}"><i class="fa fa-eye text-primary"></i></a>
                            <a  href="{{asset('admin/edit-mcq-question/'.$mcq_question->id)}}"><i class="fa fa-edit text-success"></i></a>
                            <a  href="{{asset('admin/delete-mcq-question/'.$mcq_question->id)}}" class="delete-confirm"   ><i class="fa fa-trash text-danger"></i></a>
                            @endif
