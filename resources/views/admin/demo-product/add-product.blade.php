...
<main class="main-content">
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h3>Add Demo Product</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Dashboard</a></li>                    
                    <li class="breadcrumb-item active" aria-current="page">Demo Product</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{asset('admin/demo-product-list')}}" class="btn btn-primary pull-right"><i class="fa fa-list"></i>&nbsp; Product List</a>
                        <x-flashMessage/>
                        <h6 class="card-title">Add Demo Product</h6>
                        <form action="{{asset('admin/add-demo-product')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <span id="msg" ></span>
                            <div class="form-group">
                                <label for="institute">Category</label>
