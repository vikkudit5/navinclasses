            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{asset('admin/edit-demo-product/'.Request::segment(3))}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single category" name="teacher_id" id="teacher_id">
                                    ...
                                    <option value="{{$teacher->id}}" {{($teacher->id==$product->teacher_id)?"selected":""}}>{!! $teacher->username !!}</option>
                                    @endforeach
                                   @endif
