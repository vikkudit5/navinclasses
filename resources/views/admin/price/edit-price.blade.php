                    ...
                    <div class="card-body">
                        ...
                        <form action="{{asset('admin/edit-price/'.Request::segment(3)."/".Request::segment(4))}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" value="{{$price->duration}}" min="1" name="duration"  id="duration" placeholder="Enter Duration">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" value="{{$price->price}}" min="1" name="price" id="price" placeholder="Enter price">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" value="{{$price->sort_order}}" min="1" name="sort_order"  id="sort_order" placeholder="Enter Sort order">
