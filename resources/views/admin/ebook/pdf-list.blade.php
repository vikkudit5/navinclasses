    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ebook List</li>
                </ol>
            </nav>
        </div>
        <!-- end::page header -->
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <a href="{{asset('admin/ebook-list')}}"  class="btn btn-primary"><i class="fa fa-refresh"></i>&nbsp; Reset</a>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{asset('admin/upload-ebook')}}" class="form-group btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp; Upload Pdf</a>
                ...
                <table  class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- <a  href="{{asset('admin/view-product/'.$product->id)}}"><i class="fa fa-eye text-primary"></i></a> --}}
                            {{-- <a  href="{{asset('admin/edit-product/'.$product->id)}}"><i class="fa fa-edit text-success"></i></a> --}}
                            <a  href="{{asset('admin/delete-pdf/'.$product->id)}}" class="delete-confirm"   ><i class="fa fa-trash text-danger"></i></a>
                            @endif
