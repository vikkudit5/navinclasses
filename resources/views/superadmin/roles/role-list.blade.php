...
<main class="main-content">
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <a href="{{asset('superadmin/add-roles')}}" class="btn btn-primary">Add Roles</a>
                <table id="example1" class="table table-striped table-bordered">
                    ...
                    <tr>
                        <td>{{$role->id}}</td>
                        <td>{{$role->role}}</td>
                        <td><a href="{{asset('superadmin/admin-modules/'.$role->id)}}"><i class="fa fa-plus"></i></a></td>
                        <td>
                            ...
                            @if($permission == 'read')
                            <a  href="{{asset('superadmin/view-admin-role/'.$role->id)}}"><i class="fa fa-eye text-success"></i></a>
                           
                            @endif

                            @if($permission == 'write')
                            <a  href="{{asset('superadmin/view-admin-role/'.$role->id)}}"><i class="fa fa-eye text-success"></i></a>
                            <a  href="{{asset('superadmin/edit-admin-role/'.$role->id)}}"><i class="fa fa-edit text-success"></i></a>
                            ...
                            <a  href="{{asset('superadmin/view-admin-role/'.$role->id)}}"><i class="fa fa-eye text-success"></i></a>
                            <a  href="{{asset('superadmin/edit-admin-role/'.$role->id)}}"><i class="fa fa-edit text-success"></i></a>
                            <a class="delete-confirm" href="{{asset('superadmin/delete-admin-role/'.$role->id)}}"><i class="fa fa-trash text-danger"></i></a>
                            @endif
