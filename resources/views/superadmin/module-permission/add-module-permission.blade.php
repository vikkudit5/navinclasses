            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{asset('superadmin/module-permission/'.Request::segment(3)."/".Request::segment(4))}}" class="btn btn-primary pull-right">Module Permission List</a>
                        <x-flashMessage/>
                        <h6 class="card-title">Add Module Permission</h6>
                        <form action="{{asset('superadmin/add-module-permission/'.Request::segment(3)."/".Request::segment(4))}}" method="post">
                            @csrf

                            

                            <input type="hidden" name="adminUserId" value="{{Request::segment(3)}}">
