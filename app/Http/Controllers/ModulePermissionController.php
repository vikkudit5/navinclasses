...
class ModulePermissionController extends Controller
{
     ...
     */
    public function index($admin_id,$role_id)
    {
        ...
        return view('superadmin.module-permission.module-permission',$data);
    }
    ...
    public function create($user_id,$role_id)
    {
        ...
        $data['modules'] = Admin_module::where(['role_id'=>$role_id])->get();

        $data['mainSuperAdminMenu'] = 'AdminUser';
        $data['superadminSubMenu'] = 'adminUser';
        return view('superadmin.module-permission.add-module-permission',$data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request,$user_id,$role_id)
    {
